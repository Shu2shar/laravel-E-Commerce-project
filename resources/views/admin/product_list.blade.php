                            ...
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td style="max-width: 30px">
                                        ...
                                        <a href="{{ route('admin_change_product_status', ['id' => $product->id, 'status' => $product->is_active == 1 ? 0 : 1]) }}"
                                            class="btn btn-sm btn-{{ $product->is_active == 1 ? 'danger' : 'success' }}">{{ $product->is_active == 1 ? 'Deactivate' : 'Activate' }}</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
