...
<table border="0" cellpadding="0" cellspacing="0" class="tbl1">
    <tr style="vertical-align: middle;">
        <td colspan="2" style="width: 100%;text-align: center">
            <span style="color:#03386F;font-size:50px;">E-commerce Store</span>
        </td>
    </tr>
    ...
    <tr style="vertical-align: middle;">
        <td colspan="2">
            <p style="font-size: 11px; color: #7F7F86;font-family: helvetica, arial, sans-serif;line-height: 15px; width:520px; text-align: left;">  Copyright © 2020 E-commerce Store, Inc. All rights reserved. E-commerce Store is a training portal where anyone can learn any course in vernacular languages for free. <br> Support Center: +91-00000000000 or email us at Example@example.com.
            </p>
        </td>
    </tr>
